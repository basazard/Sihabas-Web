                ...
                <div class="card bg-info ml-5 mb-5" style="width: 18rem;">
                  <div class="card-body">
                    ...
                    <h5 class="card-title">'.$f2.'</h5>
                      ...
                      <form action="Dsiswa.php" method="POST">
                        <a>
                            <input type="hidden" readonly="readonly" name="id_kelas" value="'.$f1.'"/>
                            <input type="hidden" readonly="readonly" name="nama_kelas" value="'.$f2.'"/>
                            <p class="card-text text-white">
                                <input type="submit" value="Lebih Lanjut" class="fas-fa-angle-double-right ml-2" name="submit" />
                            </p>
                        </a>
                     </form>
                  </div>
