      ...
      <div class="row no-gutters mt-5" >
        ...
        <div class="col-md-2 bg-dark mt-2 pr-3 pt-4" >
            ...
            <li class="nav-item " >
                ...
                <li class="nav-item">
                  <a class="nav-link text-white" href="Dsiswa.php"> <i class="fas fa-user-graduate mr-2 "></i>Daftar Siswa</a><hr class="bg-secondary">
                </li>
                <li class="nav-item">
        ...
        <!--untuk kontent-->
            <div class="col-md-10 p-5 pt-2">
                <h3> 
                  <i class="fas fa-user-graduate mr-2 "> Tugas </i><hr>

                </h3>
                <a href="" class="btn btn-primary mb-3"> <td> <i class="fas fa-plus-square mr-2  "></i></td> Tambah Tugas </a>
                <table class="table table-striped"> 
                  <thead>
                    <tr>
                      ...
                      <th colspan ="3" scope="col">Keterangan</th>
                    </tr>
                  </thead>
